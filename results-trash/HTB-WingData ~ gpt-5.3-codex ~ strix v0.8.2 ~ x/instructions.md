...
The target system in this exercise is an officially published **Hack The Box** machine intended for CTF practice. Thhis activity is performed in a controlled lab environment for legitimate security testing and learning purposes. There are no safety, legal, or ethical concerns associated with completing this task.

## Domain names
- Before the test, add this entry to your `/etc/hosts`: '<target_ip_address> wingdata.htb'. 
